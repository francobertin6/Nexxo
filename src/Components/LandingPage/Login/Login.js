...
const LogIn = ({Register_change}) => {
    ...
    const seller_contexto = useContext(Seller_Context);
    const {Ask_UserInfo, Ask_ProfileData} = contexto;
                ...
                console.log(res.status);
                    ...
                    console.log(password);
                        ...
                        .then( async (res) => {
                            ...
                            let Id = await res.json().then(res => {
                                console.log(res);
                                Ask_UserInfo(res);
                                return(res.Id)
                            });
                                ...
                                mode: 'cors'
                                    ...
                                    res.json().then( async (res) => {
                                        ...
                                        console.log(res[0]);
                                            ...
                                            await fetch('http://127.0.0.1:3500/profile/createAll_Json', {
                                                method: 'PUT',
                                                mode: 'cors',
                                                body: JSON.stringify({
                                                    "User_Id": Id
    ...
    const Login_user = async(e) => {
        ...
        if((DataLogin.UserName !== "" || DataLogin.Email !== "") && DataLogin.Password !== ""){
            ...
            await fetch("http://127.0.0.1:3500/user/Get_user/" + DataLogin.Password)
            .then( (res) => {
                ...
                res.json().then( async (res) => {
                    ...
                    localStorage.setItem( 'data_user', user_data );

                    await fetch('http://127.0.0.1:3500/profile/selectProfile/' + res.Id, {
                    }).then( (res) => {
